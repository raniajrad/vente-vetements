...
<style>
    ...
    .section-title {
        font-size: 2.5rem; /* Plus grand pour un titre plus accrocheur */
        font-weight: 700;  /* Texte en gras pour plus d'impact */
        color: #333; /* Couleur de texte sombre */
        position: relative; /* Pour positionner une ligne sous le titre */
    ...
    .section-title span::after {
        content: "";
        position: absolute;
        bottom: -5px; /* Positionne la ligne sous le texte */
        left: 0;
        width: 50%;
        height: 4px;
    ...
    .section-title span:hover::after {
        width: 100%; /* L'animation de l'agrandissement de la ligne */
    }

    /* Description sous le titre */
    .section-description {
        font-size: 1.1rem;
        color: #555; /* Couleur subtile pour la description */
        text-align: center;
        margin-top: 10px;
        margin-bottom: 30px;
    }
...
<section class="product_section layout_padding">
   ...
   <div class="container">
    ...
    <div class="heading_container heading_center">
        ...
        <p class="section-description">Explorez nos différentes catégories pour trouver le produit qui vous convient</p>
    </div>
    
          
           <div style="width:500px; text-align: center;  display: block; margin: 50px auto;"> 
            <form action="{{url('search_catagorie')}}" method="GET">
              @csrf
